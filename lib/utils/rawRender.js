...
function renderClass (_vdom, props, isSvg) {
  ...
  // instance._collector = {}
  instance._collector.components = instance._collector.components.concat(collector.data.components)
  instance._collector.refs = instance._collector.refs.concat(collector.data.refs)
